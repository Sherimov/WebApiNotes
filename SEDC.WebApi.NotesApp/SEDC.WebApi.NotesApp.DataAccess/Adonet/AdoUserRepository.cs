...
namespace SEDC.WebApi.NotesApp.DataAccess.Adonet
{
    public class AdoUserRepository : IRepository<User>
    {
        ...
        public void Insert(User entity)
        {
                ...
                new SqlConnection(_connectionString))
            {
                    ...
                    new SqlCommand())
                {
                    ...
                    //// bad way
                    //cmd.CommandText = 
                    //    $"INSERT INTO dbo.[User] (Username, Password, FirstName, LastName) VALUES ({entity.Username}, {entity.Password}, {entity.FirstName}, {entity.LastName})";

                    cmd.CommandText =
                        $"INSERT INTO dbo.[Users] (Username, Password, FirstName, LastName) VALUES (@userUsername, @userPassword, @userFirstName, @userLastName)";
        ...
        public void Update(User entity)
        {
            ...
            cmd.CommandText = "UPDATE dbo.[User] SET Username = @userUsername, Password = @userPassword, FirstName = @userFirstName, LastName = @userLastName WHERE Id = @id";
            cmd.Parameters.AddWithValue("@userUsername", entity.Username);
            cmd.Parameters.AddWithValue("@userPassword", entity.Password);
            cmd.Parameters.AddWithValue("@userFirstName", entity.FirstName);
            cmd.Parameters.AddWithValue("@userLastName", entity.LastName);
